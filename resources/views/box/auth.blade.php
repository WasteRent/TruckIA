	        ...
	        <div class="mt-6">
	          <form method="POST" class="space-y-6">
	            ...
	            <div>
	              ...
	              <div class="mt-1">
	                <input name="plate" type="text" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" value="{{ request()->query('plate') }}">
	              </div>
	            </div>
