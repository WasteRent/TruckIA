    ...
    <div class="sm:grid grid-cols-2 px-4 sm:px-0"> 
      <div class="mx-auto mt-10 z-50">
        ...
        <div class="flex justify-between space-x-3 mt-10">
        	<a target="_blank" href="https://truckts.com/contacto" class="bg-teal-500 text-white px-10 py-2 rounded flex items-center" type="submit">
        	  <span class="mr-2">{{ __('Contactar') }}</span>
        	</a>

        	@if($vehicle)
        	<a href="{{ route('box.login') }}?qrid={{ request()->query('qrid') }}" class=" border-2 border-teal-500 text-teal-500 px-10 py-2 rounded flex items-center" type="submit">
