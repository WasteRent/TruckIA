...
@component('components.tabs', [
	'items' => [
		...
		[
			...
			'available' => in_array(auth()->user()->job, ['fleet_manager', 'garage_boss', 'garage', 'mechanic', 'contract_manager','zone_administrator'])
		],
		[
			'name' => __('Notas'),
		...
		[
			...
			'available' => in_array(auth()->user()->job, ['fleet_manager', 'garage_boss', 'garage', 'mechanic', 'zone_administrator'])
		],
		[
			'name' => __('Garantías'),
