<div class="p-4 bg-gradient-to-br from-indigo-50 to-white rounded-xl">
	<div class="flex items-center mb-3">
		<div class="w-10 h-10 bg-indigo-600 rounded-lg flex items-center justify-center mr-3 shadow-md">
			<i class="fas fa-tachometer-alt text-white"></i>
		</div>
		<h3 class="text-lg font-bold text-gray-900">Tacógrafos</h3>
	</div>
