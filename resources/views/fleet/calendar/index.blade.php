    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-x-16">
      ...
      <ol class="mt-4 divide-y divide-gray-100 text-sm leading-6 lg:col-span-7 xl:col-span-8">
        ...
        <li class="relative flex space-x-6 py-6 xl:static">
          ...
          <div class="flex-auto">
            <h3 class="pr-10 font-semibold text-gray-900 xl:pr-0">{{ $appointment->order->vehicle->plate }} &middot; {{ $appointment->order->type == 'corrective' ? 'Correctivo':'Preventivo' }} programado.</h3>
            <dl class="mt-2 flex flex-col text-gray-500 xl:flex-row">
              <div class="flex items-start space-x-3">
                ...
                <dd><time datetime="2022-01-10T17:00">{{ Carbon\Carbon::parse($appointment->date)->isoFormat('ddd D MMMM YYYY HH:mm') }}</time></dd>
              </div>
              <div class="mt-2 flex items-start space-x-3 xl:mt-0 xl:ml-3.5 xl:border-l xl:border-gray-400 xl:border-opacity-50 xl:pl-3.5">
                ...
                <dd>{{ $appointment->order->vehicle->customer->name }}</dd>
              </div>
              <div class="mt-2 flex items-start space-x-3 xl:mt-0 xl:ml-3.5 xl:border-l xl:border-gray-400 xl:border-opacity-50 xl:pl-3.5">
                <dt class="mt-0.5">
                ...
                <dd>{{ $appointment->order->garage->name }}</dd>
              </div>
            </dl>
          </div>
        </li>
