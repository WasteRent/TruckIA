    ...
    {!! Form::open([
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <div class="w-full md:w-1/5 px-3 mb-6 md:mb-0">
          ...
          {!! Form::select('job', ['garage_boss' => 'Jefe de taller', 'capataz' => 'Capataz', 'mechanic' => 'Mecánico', 'fleet_manager' => 'Gestor de flota', 'driver' => 'Conductor'], null, ['placeholder' => '', 'class' => 'form-select']) !!}
        </div>
      ...
      <div class="my-6">
        ...
        @foreach(\App\Models\Customer::where('fleet_id', Auth::user()->fleet->id)->orderBy('name')->get() as $customer)
          <li class="flex items-center">
            <input class="mr-2" type="checkbox" name="allowed_customer_id[]" value="{{ $customer->id }}" checked> {{ $customer->name }}
          </li>
        @endforeach
        </ul>
      </div>
