<div class="sm:rounded-lg w-full rounded bg-white border-b sm:mb-3 mb-4 sm:overflow-hidden" style="box-shadow: 0 2px 6px 0 rgb(218 218 253 / 65%), 0 2px 6px 0 rgb(206 206 238 / 54%);">
