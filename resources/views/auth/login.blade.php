...
<div class="relative max-w-md mx-auto">
  ...
  <div class="max-w-xs mx-auto">
    ...
    <img class="mx-auto h-24 w-auto" src="{{ asset('img/truck-i-l.png') }}" alt="truckts-logo" />
    ...
    <div class="mt-6">
      <button class="group w-full flex justify-center py-2 px-4 border border-transparent text-sm font-bold rounded-md text-white bg-teal-500 hover:bg-teal-500lighter focus:outline-none focus:border-teal-700 focus:ring-teal active:bg-teal-500 transition duration-150 ease-in-out" type="submit">
        {{ __('Entrar') }}
      </button>
    </div>
  </div>
