@php
	...
	if(in_array(Auth::user()->id, [3,920, 929,872,637, 928,955,904,1034,1033,1413,2169,1035,2222,892,904,664]) || in_array(Auth::user()->job, ['contract_manager', 'zone_administrator'])) {
		$enlaces[] =
				[
