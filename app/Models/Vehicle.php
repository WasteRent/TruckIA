...
class Vehicle extends EloquentModel implements \OwenIt\Auditing\Contracts\Auditable
{
    ...
    public function incrementEquipmentHours(float $read)
    {
        $this->increment('equipment_work_hours', $read);
    ...
    public static function filter(array $filters)
    {
        ...
        if (isset($filters['registration_date_to']) && $filters['registration_date_to'] != null) {
            $query->where('registration_date', '<=', $filters['registration_date_to']);
        }
