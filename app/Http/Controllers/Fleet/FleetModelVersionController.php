...
class FleetModelVersionController extends Controller
{
    public function index(Model $model)
    {
        return view('fleet.manufacturers.models.versions.index', [
    ...
    public function store(VersionRequest $request, Model $model)
    {
        ...
        return redirect()->route('fleet.models.versions.index', $model)
