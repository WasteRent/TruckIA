...
class FleetVehicleDeliveryNotesController extends Controller
{
    ...
    public function update(Request $request, Vehicle $vehicle, VehicleDeliveryNote $delivery)
    {
        ...
        $delivery->update([
            ...
            'check_front_tire_right' => $request->front_tire_right,
            'check_front_tire_left' => $request->front_tire_left,
            'check_tire_2_axis_right' => $request->tire_2_axis_right,
            'check_tire_2_axis_left' => $request->tire_2_axis_left,
            'check_tire_3_axis_right' => $request->tire_3_axis_right,
            'check_tire_3_axis_left' => $request->tire_3_axis_left,
            'check_front_axle_mud_flaps' => $request->front_axle_mud_flaps,
            'check_axle_2_mud_flaps' => $request->axle_2_mud_flaps,
            'check_axle_3_mud_flaps' => $request->axle_3_mud_flaps,
            'check_fire_extinguishers' => $request->fire_extinguishers,
            'check_battery_cap' => $request->battery_cap,
            'check_windows_glass' => $request->windows_glass,
            'check_fuel_adblue_cap' => $request->fuel_adblue_cap,
            'check_rotating_work_lights' => $request->rotating_work_lights,
            'check_headlights_pilots_lamps' => $request->headlights_pilots_lamps,
            'check_right_mirror' => $request->right_mirror,
            'check_left_mirror' => $request->left_mirror,
            'check_interior_cleaning' => $request->interior_cleaning,
            'check_exterior_cleaning' => $request->exterior_cleaning,
            'check_vest_triangle_light' => $request->vest_triangle_light,
            'check_documentation' => $request->documentation,
        ]);
