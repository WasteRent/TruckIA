...
class GarageFastOrderController extends Controller
{
    public function create(Request $request)
    {
        ...
        return view('garage.repair_orders.fast_orders.create', [
            'vehicle' => $vehicle,
            'garages' => collect([auth()->user()->garage]),
            'user' => $user,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('garage.repair-orders.show', $order);
        } catch (\Exception $e) {
            DB::rollBack();
            throw $e;
        }
