...
->group(function () {
    ...
    Route::resource('repair-orders.vehicles', 'AdminRepairOrderVehicleController')->only(['edit', 'update']);
    Route::resource('repair-orders.garages', 'AdminRepairOrderGarageController')->only(['edit', 'update']);
