...
->group(function () {
    ...
    Route::get('containers/checklists/memoria-inspecciones-reparaciones-contenedores', 'FleetContainerChecklistPdfController@reparationsInspectionsMemoryPdf')->name('containers.checklists.range-pdf');
